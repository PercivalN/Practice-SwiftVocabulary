...
class WordsTableViewController: UITableViewController {
    ...
    @IBAction func addWord(_ sender: UIBarButtonItem) {
        ...
        var wordText: UITextField?
        var definitionText: UITextField?
        ...
        alert.addAction(UIAlertAction(title: "SAVE", style: .default) { (action:UIAlertAction) in
            ...
            if let word = wordText?.text, let definition = definitionText?.text {
                self.createNewVocabularyWord(with: word, and: definition)
        ...
        alert.addTextField { (wordTextField) in
            wordText = wordTextField
            wordText?.placeholder = "Enter word"
        }
        
        alert.addTextField { (definitionTextField) in
            definitionText = definitionTextField
            definitionText?.placeholder = "Enter definition"
        }
